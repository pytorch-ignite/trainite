...
from trainite.shared.builders import build_dataloaders, build_model, resolve_vocab_size
from trainite.shared.handlers import (
...
from trainite.shared.utils import dump_config, instantiate
...
class Trainer:
    def __init__(self, config: ProjectConfig) -> None:
        ...
        self.checkpointers = setup_checkpointing(
            self.engine, self.val_evaluator, {"model": self.model, "optimizer": self.optimizer}, self.run_dir
        )
